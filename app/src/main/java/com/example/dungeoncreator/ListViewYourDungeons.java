...
public class ListViewYourDungeons extends BaseAdapter {

    DatabaseHelper db;
    Context context;
    private ArrayList<Integer> dungeons;

    public ListViewYourDungeons(Context c,ArrayList<Integer> d) {
        context = c;
        dungeons = d;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            LayoutInflater mInflator = (LayoutInflater) context.getSystemService(YourDungeons.LAYOUT_INFLATER_SERVICE);
